...
export function drawThreeGeo({ json, radius, materialOptions }) {
  ...
  function drawLine(x_values, y_values, z_values, options) {
    ...
    // if options provided, use them (simple solid line). Otherwise use fancy dashed LineMaterial.
    if (options && (options.color || options.linewidth || options.opacity)) {
      ...
      // LineMaterial (from examples) expects color as THREE.Color; linewidth is in pixels
